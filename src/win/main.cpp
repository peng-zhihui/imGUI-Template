...
//    io.Fonts->AddFontDefault();
    io.Fonts->AddFontFromFileTTF("../imgui-1.83/misc/fonts/msyh.ttc", 20.0f, nullptr, io.Fonts->GetGlyphRangesChineseFull());
//    io.Fonts->AddFontFromFileTTF("../imgui-1.83/misc/fonts/Roboto-Medium.ttf", 16.0f);
//    io.Fonts->AddFontFromFileTTF("../imgui-1.83/misc/fonts/Cousine-Regular.ttf", 15.0f);
//    io.Fonts->AddFontFromFileTTF("../imgui-1.83/misc/fonts/DroidSans.ttf", 16.0f);
//    io.Fonts->AddFontFromFileTTF("../imgui-1.83/misc/fonts/ProggyTiny.ttf", 10.0f);
...
//    IM_ASSERT(font != nullptr);
    ...
    while (!done)
    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to created a named window.
        {
            ...
            ImGui::Text("#测试文本");               // Display some text (you can use a format strings too)
            ImGui::Checkbox("示例窗口", &show_demo_window);      // Edit bools storing our window open/close state
            ImGui::Checkbox("另一个示例窗口", &show_another_window);
